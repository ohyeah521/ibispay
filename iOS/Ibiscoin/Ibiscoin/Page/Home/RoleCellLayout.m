...
- (void)_layout {
    ...
    _attrHeight = 0;
    _attrHeight2 = 0;
    _marginBottom = kRoleCellBottomMargin;
    ...
    if (_picHeight > 0) {
        _height += _picHeight;
        _height += kRoleCellContentRightPadding;
    }
...
- (void)_layoutHeader {
    ...
    _nameBottomHeight = kRoleCellNameBottomHeight;
}
...
- (void)_layoutName{
    ...
    strCoin.font = [UIFont systemFontOfSize:kRoleCellCoinNameFontSize weight:UIFontWeightMedium];
    ...
    strName.font = [UIFont systemFontOfSize:kRoleCellNameFontSize weight:UIFontWeightUltraLight];
    if (role.sponsor == YES) {
    ...
    YYTextContainer *container = [YYTextContainer containerWithSize:CGSizeMake(kRoleCellNameWidth, 9999)];
...
- (void)_layoutTag{
    ...
    str.font = [UIFont systemFontOfSize:kRoleCellTagFontSize weight:UIFontWeightUltraLight];
    ...
    modifier.font = [UIFont systemFontOfSize:kRoleCellTagFontSize weight:UIFontWeightUltraLight];
    
    YYTextContainer *container = [YYTextContainer containerWithSize:CGSizeMake(kRoleCellTagWidth, 9999)];
...
- (void)_layoutDetails{
    ...
    text.font = [UIFont systemFontOfSize:kRoleCellContentFontSize weight:UIFontWeightRegular];
...
//    text.alignment = NSTextAlignmentJustified;
    ...
    for (NSTextCheckingResult *tag in tagResults) {
        ...
        if ([text attribute:YYTextHighlightAttributeName atIndex:tag.range.location] == nil) {
            ...
            [text setFont:[UIFont systemFontOfSize:kRoleCellContentFontSize weight:UIFontWeightLight] range:tag.range];
            
            // 高亮状态
            YYTextHighlight *highlight = [YYTextHighlight new];
            [highlight setBackgroundBorder:highlightBorder];
            // 数据信息，用于稍后用户点击
            highlight.userInfo = @{@"kRoleCellDescTagKey" : [text.string substringWithRange:NSMakeRange(tag.range.location + 1, tag.range.length - 1)]};
    ...
    modifier.paddingTop = kRoleCellPaddingText;
    modifier.paddingBottom = kRoleCellPaddingText;
    
    YYTextContainer *container = [YYTextContainer new];
    container.size = CGSizeMake(kRoleCellContentWidth, HUGE);
    container.linePositionModifier = modifier;
...
- (void)_layoutAttr1{
    ...
    text.font = [UIFont systemFontOfSize:kRoleCellAttrFontSize weight:UIFontWeightUltraLight];
    text.color = kColorGray1;
    text.lineBreakMode = NSLineBreakByTruncatingTail;
    
    YYTextContainer *container = [YYTextContainer new];
    container.size = CGSizeMake(kRoleCellContentWidth, 999);
    container.maximumNumberOfRows = 1;
    _attrLayout = [YYTextLayout layoutWithContainer:container text:text];
    _attrHeight = kRoleCellPadding+kRoleCellPaddingText;
}
...
-(void)_layoutAttr2{
    ...
    YYTextContainer *container = [YYTextContainer new];
    container.size = CGSizeMake(kRoleCellContentWidth-64, 999);
    container.maximumNumberOfRows = 1;
    _attrLayout2 = [YYTextLayout layoutWithContainer:container text:text];
    _attrHeight2 = kRoleCellPadding+kRoleCellPaddingText;
}
...
- (void)_layoutTime{
    ...
    text.font = [UIFont systemFontOfSize:kRoleCellTimeFontSize weight:UIFontWeightUltraLight];
    text.color = kColorGray1;
    text.lineBreakMode = NSLineBreakByTruncatingTail;
...
//    CGFloat len1_3 = (kRoleCellContentWidth + kRoleCellPaddingPic) / 3 - kRoleCellPaddingPic;
...
//                    CGFloat maxLen = kRoleCellContentWidth;
...
//            case 2: case 3:{
//                CGFloat maxLen = kRoleCellContentWidth;
//                CGFloat halfLen = CGFloatPixelRound((maxLen-kRoleCellPaddingPic)/2);
...
//                //                picHeight = len1_3 * 2 + kRoleCellPaddingPic;
//                //            } break;
//            case 9:{
//                picSize = CGSizeMake(len1_3, len1_3);
//                picHeight = len1_3 * 3 + kRoleCellPaddingPic * 2;
//            }break;
//
//            default: { // 4、5、6、7, 8
//                CGFloat maxLen = kRoleCellContentWidth;
