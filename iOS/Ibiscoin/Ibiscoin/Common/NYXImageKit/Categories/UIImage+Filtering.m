...
//    CGImageRef img = CGImageCreateWithMask(grayscaledImageRef, mask);
//    UIImage *grayscaled = [UIImage imageWithCGImage:img scale:self.scale orientation:self.imageOrientation];
//    
//	/// Cleanup
//    if (img) {
//        CGImageRelease(img);//coo mark
//    }
//    if (mask) {
//        CFRelease(mask);//coo mark
//    }
