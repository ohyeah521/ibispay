                  ...
                  completion:(KSImageManagerCompletionBlock)completion
{
    ...
    [imageView setImageWithURL:imageURL placeholder:placeholder options:kNilOptions progress:progressBlock transform:nil completion:completionBlock];//coo mark
}

- (void)cancelImageRequestForImageView:(UIImageView *)imageView {
    [imageView cancelCurrentImageRequest];//coo mark
}
